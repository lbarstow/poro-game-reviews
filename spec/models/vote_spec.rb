...
RSpec.describe Vote, type: :model do
  let!(:game_1) { Game.create!(name: "Arkham Horror", min_player_count: 1, max_player_count: 8, description: "Horror game where you can punch Cthulhu in the face") }
  ...
  let!(:review_1) { Review.create!(rating: 4, body: "Great game!!!", victory_points: 1, game: game_1, user: user_1) }
